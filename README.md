...
| Full Sync                 | Downloads and validates all<br>blocks and transactions                    | Minimum 1 TB        | Desktop computer or<br>laptop newer than 2021 | `--Sync.Mode=Full`                                     | `--Pruning.Mode=Memory` <br> or <br> `--Pruning.Mode=Hybrid` | `geth --syncmode full`                  |
| Archive Node              | Stores all historical<br>blockchain states                                | Minimum 1 TB        | Desktop computer or<br>laptop newer than 2021 | `--Sync.Mode=Full`                                     | `--Pruning.Mode=None`                                        | `geth --syncmode full --gcmode archive` |
