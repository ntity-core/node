...
# Configuration
LOG_FILE = "./proposals.log"
PROCESSED_FILE = "./proposals.json"
APPROUVAL_API_URL = "https://gbm.ntity.io/front/api/ntity/misc/approval"
DOCKER_URL = "http://127.0.0.1:8545"
...
def get_proposals():
    ...
    try:
        ...
        response = requests.get(APPROUVAL_API_URL, headers=headers, verify=False)
